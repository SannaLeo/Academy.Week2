...
namespace AcademyF.Week2.EsercitazioneDesignPattern.Test
{
    public class ChainTest
    {
        ...
        [Fact]
        public void ShouldBeSeniorEmployee45YearsOld()
        {
            //Ho un impiegato vincitore del premio anzianita con 52 anni di servizio
            ...
            {
                DateOfBirth = new DateTime(1997, 1, 1),
                DateHiring = new DateTime(1972, 1, 1)
            };

            IHandler ageHandler = new SeniorHandler();

            //ACT 

            //Chiamata al metodo che gestisce la richiesta per l'impiegato creato
            double premio = ageHandler.HandleRequest(employee);

            //ASSERT

            //Verifico che il premio sia uguale a 280
            Assert.Equal(280, premio);
        }
        ...
        [Fact]
        public void ShouldHaveProductivityBonusInChainWithFourHandlers()
        {
            //Ho un impiegato vincitore del premio produttività in una catena
            //costituita dall'anello premio assenza e successivamente quello di produttività
            //voglio che la richiesta passi attraverso i due anelli della catena
            ...
            absenceHandler.SetNext(productiviryHandler).SetNext(agehandler).SetNext(wellbeinghandler);
        ...
        [Fact]
        public void ShouldHaveWellBeingBonusInChainWithFourHandlers()
        {
            //Ho un impiegato vincitore del premio produttività in una catena
            //costituita dall'anello premio assenza e successivamente quello di produttività
            //voglio che la richiesta passi attraverso i due anelli della catena
            ...
            //Verifico che il premio sia uguale a 310
            Assert.Equal(310, premio);
        }
    }
}
